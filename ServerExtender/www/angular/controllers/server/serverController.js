define(['angular/application'], function () {
    ...
    .controller('serverController', ['$scope', '$rootScope', '$timeout', 'serverHubService', 'consoleHubService', '$route', serverController]);

    function serverController($scope, $rootScope, $timeout, serverHubService, consoleHubService, $route) {
